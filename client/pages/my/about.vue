...
<script>
  ...
  export default {
    ...
    async asyncData({ route, redirect, store, query }){
      ...
      if (comtyInfo.logo && comtyInfo.logo.url) {
        comtyInfo.comtyLogo = comtyInfo.logo.url;
      } else {
        switch (comtyInfo.type) {
        case 1:
          comtyInfo.comtyLogo = require("~/assets/images/bg_bbs_company@2x.png");
          break;
        case 2:
          comtyInfo.comtyLogo = require("~/assets/images/me_bg_bbs_facility@2x.png");
          break;
        default:
          comtyInfo.comtyLogo = require("~/assets/images/me_bg_bbs_hospital@2x.png");
        }
      }*/
